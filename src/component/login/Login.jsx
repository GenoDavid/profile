...
const Login = () => {
    ...
    return (
        <div>
            <form className={classes.formcontainer} onSubmit={(handleSubmit((data) => { }))}>
                <div className={classes.logocontainer}></div>

                <div className={classes.titlecontainer}>
                    <p className={classes.title}>Login to your Account</p>
                    <span className={classes.subtitle}>Get started with our app, just create an account and enjoy the experience.</span>
                </div>
                <br />
                <div className={classes.inputcontainer}>
                    <label className={classes.inputlabel} for="email_field">Email</label>
                    ...
                    {/* <i><GoMail /></i> */}
                    <input {...register('mail', { required: 'Not Found A Account' })} placeholder="name@mail.com" title="Enter Mail" name="input-name" type="text" className={classes.inputfield} id="email_field" />
                    {errors?.mail && <p>{errors.mail.message}</p>}
                </div>
                <div className={classes.inputcontainer}>
                    <label className={classes.inputlabel} for="password_field">Password</label>
                    <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" className={classes.icon}>
                    ...
                    <input  {...register('pass', { required: 'Wrong Passowrd' })} placeholder="Password" title="Password" name="input-name" type="password" className={classes.inputfield} id="password_field" />
                ...
                <button title="Sign In" type="submit" className={classes.signinapl}>
                    <span><Link to='/register'>Creat Account</Link></span>
                </button>
